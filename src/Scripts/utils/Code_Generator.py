...
for i in range(16):
    for j in range(16):
        print("8'h", hex(count).replace("0x", "").zfill(2), ": data_out = 8'h", hex(InvSBox[i][j]).replace("0x", "").zfill(2), ";", sep="")
        count = count + 1

# for i in range(64):
#     print("6'd", i, ": data_out = 64'd", pow(2, i), ";", sep="")

# for i in range(16):
#     print("in_", i, ",", sep="")

# for i in range(16):
#     print("4'd", i, ": data_out = in_", i, ";", sep="")

# for i in range(64):
#     print("REG REG_Inst", i, "(", sep="")
#     print("    .data_out(Reg_", i, "_Out),", sep="")
#     print("    .data_in(data_in),", sep="")
#     print("    .Clk(Clk),", sep="")
#     print("    .Rst(Rst),", sep="")
#     print("    .En(Decoder_Out[", i, "])", sep="")
#     print(");")
